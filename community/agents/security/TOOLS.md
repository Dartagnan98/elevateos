...
## Core Bus Commands
All standard ElevateOS bus commands apply. See `.claude/skills/bus-reference/SKILL.md` for the full reference.
...
| `elevate bus list-agents --format json` | Audit running agent configurations |
