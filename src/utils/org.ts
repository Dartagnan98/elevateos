 ...
 *
 * ElevateOS treats the filesystem-exact spelling of an org directory as the
 ...
 * `elevateos bus kb-* --org acmecorp` invocation was enough to
 * bootstrap a phantom `~/.elevate/default/orgs/acmecorp/` with a
