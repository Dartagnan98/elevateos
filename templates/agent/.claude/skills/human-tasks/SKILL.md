...
HUMAN_TASK_ID=$(elevateos bus create-task \
...
elevateos bus update-task "$YOUR_TASK_ID" in_progress \
...
**Good:** "1. Go to openai.com/account/api-keys. 2. Click 'Create new secret key'. 3. Name it 'elevate-myorg'. 4. Copy the key (starts with sk-...). 5. Open Terminal and run: echo 'OPENAI_API_KEY=<your-key>' >> ~/elevateos/orgs/myorg/.env"
