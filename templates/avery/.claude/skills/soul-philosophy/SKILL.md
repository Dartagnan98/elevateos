...
- **Log**: If you caught yourself rationalizing, log it: `elevate bus log-event action guardrail_triggered info --meta '{"guardrail":"<which>","context":"<what happened>"}'`
