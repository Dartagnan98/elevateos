...
> Port any existing agent workspace — ElevateOS legacy, custom Claude setup, or any other agent system — into a ElevateOS v2 agent. This skill is for the orchestrator. Run it when the user wants to bring an existing agent into the system.
